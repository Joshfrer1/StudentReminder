...
public final class AddReminderBinding implements ViewBinding {
  ...
  private AddReminderBinding(@NonNull ConstraintLayout rootView) {
  ...
  public static AddReminderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.add_reminder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static AddReminderBinding bind(@NonNull View rootView) {
    ...
    return new AddReminderBinding((ConstraintLayout) rootView);
  }
}
